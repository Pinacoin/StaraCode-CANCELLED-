			...
			case 'street':
				{
						...
						var stageFront:FlxSprite = new FlxSprite(-550, -400).loadGraphic(Paths.image('street/streetBG'));
						...
						bottomBoppers.frames = Paths.getSparrowAtlas('street/spectators');
						bottomBoppers.animation.addByPrefix('bop', 'SpectatorsBop', 24, false);
						bottomBoppers.antialiasing = true;
						bottomBoppers.scrollFactor.set(0.9, 0.9);
						bottomBoppers.setGraphicSize(Std.int(bottomBoppers.width * 1));
						bottomBoppers.updateHitbox();
